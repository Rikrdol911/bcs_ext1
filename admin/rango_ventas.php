...
<h4>Total Fact (piezas): '.number_format($tmonto1,2,",",".").' Bs<br>
Total IVA: '.number_format($total_iva,2,",",".").' Bs<br>Total Facturado + IVA: '.number_format(($total_iva+($total_monto)),2,",",".").' Bs</h4>
              </div>';
?>
<?php 
}
