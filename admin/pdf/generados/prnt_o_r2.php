...
<span class="span3"><?php echo "<b>OR ".$numero_or."</b><br>Fecha:&nbsp;".$fechahoy."<br>&nbsp;<b>".$nombre_cliente."</b><br>".$nombre_tipo."&nbsp;-&nbsp;".$dni."<br>Tel&eacute;fono&nbsp;".$telefono_cliente."<br>&nbsp;".$correo; ?> </span>
</td>
</tr>
...
<br><hr><?php echo number_format(($todo+(($todo*$iva)/100)),2,",","."); ?>&nbsp;Bs</td>
</tr>
