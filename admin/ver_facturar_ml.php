  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ver Ventas MercadoLibre</li>
      </ol>
    </section>
  <!-- /.Content Header (Page header) -->
...
<div class="box box-primary collapsed-box">
            <div class="box-header with-border" data-widget="collapse">
              <h3 class="box-title">Buscar Venta MercadoLibre</h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="formulario" role="form" method="GET" enctype="multipart/form-data" action="rango_ventas_ml.php">
              <div class="box-body">
                       <!-- Date range -->
...
<?php
$consulta=("SELECT * FROM factura WHERE habilitado=0 AND ml=0");
      $s=cons($consulta);
      ...
      echo alerta("No hay Ventas MercadoLibre registradas");  
        ...
        echo '<div class="box box-danger">
            <div class="box-header with-border text-center">
              <h3 class="box-title">Ventas MercadoLibre</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
Total Neto Ventas ML: '.number_format($total_mercado,2,",",".").' Bs
<br>Comisi&oacute;n ML: '.number_format($total_iva,2,",",".").'
