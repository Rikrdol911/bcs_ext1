...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="ver_facturar_mo.php"><i class="fa fa-dashboard"></i> Volver</a></li>
...
<h3 class="box-title">Resultado fechas del: <?php echo $fecha1." al ".$fecha2; ?><br></h3>
</div>
<div class="box-body">
<?php
$consulta=("SELECT * FROM factura WHERE habilitado=0 AND ml=1 AND fecha BETWEEN date('$fecha1') AND date('$fecha2')");
      $s=cons($consulta);
...
Total IVA: '.number_format($total_iva,2,",",".").' Bs
<br>Total Mostrador: '.number_format($total_venta11,2,",",".").'
